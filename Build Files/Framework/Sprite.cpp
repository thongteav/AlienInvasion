...
void
Sprite::Draw(BackBuffer& backbuffer, int width, int height)
{
	backbuffer.DrawSprite(*this, width, height);
}

void
Sprite::DrawRotate(BackBuffer& backbuffer)
{
	backbuffer.DrawRotatedSprite(*this);
}
